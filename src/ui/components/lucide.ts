...
export const ChevronDown = obsidianIcon(lucideSvelte.ChevronDown);
...
export const LayoutGrid = obsidianIcon(lucideSvelte.LayoutGrid);
export const List = obsidianIcon(lucideSvelte.List);
export const Plus = obsidianIcon(lucideSvelte.Plus);
export const Trash2 = obsidianIcon(lucideSvelte.Trash2);
